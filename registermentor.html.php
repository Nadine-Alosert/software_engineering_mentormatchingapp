...
$pageTitle="Register";
  ...
  <h1>Mentor registration</h1>
    ...
    <input type="checkbox" id="myCheck" name="test" required> I agree to Mentoring Privacy Policy & Terms
     ...
     <button type="submit" name="registerbuttonmentor" class="btn btn-primary" onclick="myFunction()">Create Account</button>
     <br><br><h6>Already have an account?</h6><a href='index.php?page=login'>Login here</a>
     <br><a href='index.php?page=registermentee'>Become a mentee</a>
    </form>
    <p id="demo"></p>
